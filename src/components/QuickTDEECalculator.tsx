...
export default function QuickTDEECalculator() {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Quick Calorie Calculator</h2>
      ...
      <form onSubmit={calculateTDEE} className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <motion.a
            href="/calculator"
            className="flex-1 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white px-6 py-3 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors text-center"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          >
            Detailed Calculator
      ...
      {calories && (
        ...
        >
          ...
          <div className="text-3xl font-bold text-primary-600 dark:text-primary-400">{calories} kcal</div>
          <a 
            href="/calculator" 
