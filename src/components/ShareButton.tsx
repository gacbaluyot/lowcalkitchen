  ...
  const socialLinks = [
    {
      ...
      url: `https://www.facebook.com/sharer/sharer.php?u=${encodedUrl}&quote=${encodedTitle}&hashtag=%23LowCalorieKitchen`,
    ...
    },
    {
      ...
      url: `https://twitter.com/intent/tweet?text=${encodedTitle}&url=${encodedUrl}&hashtags=LowCalorieKitchen,HealthyRecipes`,
          ...
          <div className="p-2 space-y-1">
            {socialLinks.map((social) => (
              <a
                ...
                className={`flex items-center gap-3 px-3 py-2 rounded-lg text-white ${social.color} transition-colors`}
              >
                {social.icon}
                {social.name}
              </a>
